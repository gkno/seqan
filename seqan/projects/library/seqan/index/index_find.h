...
//			_Diff _lcp = Max(_lcpLower, _lcpUpper);
	...
	//////////////////////////////////////////////////////////////////////////////
	// substring search with enhanced LCP/SA-table (hybrid table)
	//
	...
	template <
		...
		class SubTextFwdIt
	>
	inline HybridTreeIt _Lower_bound_hybrid(
		TextRndIt _TextFirst,
		TextRndIt _TextLast,
		HybridTreeIt _HybridTop,
	...
	{	// find first element not before _Val, using operator<
		...
		for (; 1 < _Delta; )
		{	// divide and conquer, find half that contains answer
			_Diff _Delta2 = _HybridTop.leftSize();

			if (_lcpLower > _lcpUpper) {
				HybridTreeIt leftChild = _HybridTop;
				leftChild.left();
				_Diff _lcpMidLower = (*leftChild).i1;
				...
				if (_lcpMidLower > _lcpLower) {
					...
					// first half
					_lcpUpper = _lcpMidLower;
					_HybridTop = leftChild;
					if ((_Delta = _Delta2) == 1)
						_Delta = 0;
					continue;
				}
			} else if (_lcpLower < _lcpUpper) {
				HybridTreeIt rightChild = _HybridTop;
				rightChild.right();
				_Diff _lcpMidUpper = (*rightChild).i1;
        ...
        while (true) {
			TextRndIt _T = _TextFirst;
			goFurther(_T, (*_HybridTop).i2 + _lcp);
			_Diff i = Min(difference(_T, _TextLast), difference(_S, _SubTextLast));
			for(; i && *_T == *_S; --i, ++_T, ++_S);
	...
	template <
		...
		class SubTextFwdIt
	>
	inline HybridFwdIt lower_bound(
		TextRndIt _TextFirst,
		TextRndIt _TextLast,
		TreeIterator<HybridFwdIt, LeftCompleteTree> _LCPTop,
		SubTextFwdIt _SubTextFirst,
		SubTextFwdIt _SubTextLast)
	{	// find first element not before _Val, using operator<
		return _Lower_bound_hybrid(
			_TextFirst, _TextLast,
			_LCPTop,
	...
	template <
		...
		class SubTextFwdIt
	>
	inline HybridTreeIt _Upper_bound_hybrid(
		TextRndIt _TextFirst,
		TextRndIt _TextLast,
		HybridTreeIt _HybridTop,
        typename Difference<TextRndIt>::Type _Delta,
	...
	template <
		...
		class SubTextFwdIt
	>
	inline HybridFwdIt upper_bound(
		TextRndIt _TextFirst,
		TextRndIt _TextLast,
		TreeIterator<HybridFwdIt, LeftCompleteTree> _LCPTop,
		SubTextFwdIt _SubTextFirst,
	...
	template <
		...
		class SubTextFwdIt
	>
	inline Pair<HybridFwdIt> _Equal_range_hybrid(
		TextRndIt _TextFirst,
		TextRndIt _TextLast,
		TreeIterator<HybridFwdIt, LeftCompleteTree> _HybridTop,
        typename Difference<TextRndIt>::Type _Delta,
		SubTextFwdIt _SubTextFirst,
		SubTextFwdIt _SubTextLast)
	{	// find first element not before _Val, using operator<
		...
		{	// divide and conquer, find half that contains answer
			...
			if (_lcpLower > _lcpUpper) {
				TreeIterator<HybridFwdIt, LeftCompleteTree> leftChild = _HybridTop;
				leftChild.left();
				_Diff _lcpMidLower = (*leftChild).i1;
				...
				TreeIterator<HybridFwdIt, LeftCompleteTree> rightChild = _HybridTop;
				rightChild.right();
				_Diff _lcpMidUpper = (*rightChild).i1;
			...
			{	// range straddles mid, find each end and return
				HybridFwdIt _First2 = _Lower_bound_hybrid(
					_TextFirst,	_TextLast,
					_HybridTop.leftChild(), (_Delta2 > 1)? _Delta2: 0,
					_SubTextFirst, _SubTextLast,
					_lcpLower, _lcp);
				_HybridTop.right();
				if ((_Delta -= _Delta2) == 1) {
				...
				HybridFwdIt _Last2 = _Upper_bound_hybrid(
					_TextFirst,	_TextLast,
					_HybridTop, _Delta,
					_SubTextFirst, _SubTextLast,
					_lcp, _lcpUpper);
				return Pair<HybridFwdIt> (_First2, _Last2);
			}
		}

		// range straddles mid, find each end and return
		return Pair<HybridFwdIt> (
			_Lower_bound_hybrid(
				_TextFirst,	_TextLast,
				_HybridTop, _Delta,
				_SubTextFirst, _SubTextLast,
	...
	template <
		...
		class SubTextFwdIt
	>
	inline Pair<HybridFwdIt> equal_range(
		TextRndIt _TextFirst,
		TextRndIt _TextLast,
		HybridFwdIt _HybridTop,
		SubTextFwdIt _SubTextFirst,
		SubTextFwdIt _SubTextLast)
	{	// find first element not before _Val, using operator<
...
*/
	...
	template <
		...
		class TLCPH,
		class TSubText >
	inline Pair<typename Iterator<TLCPH const>::Type> equalRangeLCPH(
		TText const &text,
		TLCPH const &hybrid,
		TSubText const &subtext)
	{	// find first element not before _Val, using operator<
