...
//{
	...
	template <typename T> const unsigned _SkewDC3<T>::VALUE = { 2,   1, 2 };
    ...
    struct Pipe< TInput, Skew3 >
    {
        ...
        // step 1
		typedef Pipe< TInput, Sampler<3, _SkewDC3<>::VALUE > >  TSamplerDC3;          
        ...
        bool process(_TInput &textIn, unsigned maxdepth = 0, unsigned depth = 1) {
            ...
            SEQAN_PROMARK("Rekursionsabstieg");
                ...
                ::std::cout << "enter level " << depth << ::std::endl;
            #endif
            {
