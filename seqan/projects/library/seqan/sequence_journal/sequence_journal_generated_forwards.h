...
struct inorder_dbg_print;       	// "projects/library/seqan/sequence_journal/string_journal_node.h"(126)

//____________________________________________________________________________
// inorder_offset

struct inorder_offset;       	// "projects/library/seqan/sequence_journal/string_journal_node.h"(131)

//____________________________________________________________________________
// inorder_print

struct inorder_print;       	// "projects/library/seqan/sequence_journal/string_journal_node.h"(121)
...
template <typename TString > struct suffix_compare_functor;       	// "projects/library/seqan/sequence_journal/string_journal_utility.h"(30)

//____________________________________________________________________________
// tree_visitor

struct tree_visitor;       	// "projects/library/seqan/sequence_journal/string_journal_node.h"(110)
...
template <typename TIter > inline bool j_goDownLeft( TIter &it );       	// "projects/library/seqan/sequence_journal/iterator_journal.h"(315)

//____________________________________________________________________________
// j_goDownRight

template <typename TIter > inline bool j_goDownRight( TIter &it );       	// "projects/library/seqan/sequence_journal/iterator_journal.h"(300)

//____________________________________________________________________________
// j_goNext

template <typename TIter > inline bool j_goNext( TIter &it );       	// "projects/library/seqan/sequence_journal/iterator_journal.h"(282)

//____________________________________________________________________________
// j_goPrev

template <typename TIter > inline bool j_goPrev( TIter &it );       	// "projects/library/seqan/sequence_journal/iterator_journal.h"(352)

//____________________________________________________________________________
// j_goUp

template <typename TIter > inline size_t j_goUp( TIter &it );       	// "projects/library/seqan/sequence_journal/iterator_journal.h"(330)
...
template <typename TIndex, typename TString > void printSA( TIndex & index, TString & string );       	// "projects/library/seqan/sequence_journal/string_journal_utility.h"(4)

//____________________________________________________________________________
// printSA_LCP

template <typename TIndex, typename TString > void printSA_LCP( TIndex & index, TString & string );       	// "projects/library/seqan/sequence_journal/string_journal_utility.h"(14)
...
template <typename TIndex, typename TString > void synchronize_ChildTab( TIndex & index, TString & string, std::vector<Entry>& entries );       	// "projects/library/seqan/sequence_journal/string_journal_utility.h"(624)

//____________________________________________________________________________
// synchronize_SA_LCP

template <typename TIndex, typename TString > void synchronize_SA_LCP( TIndex & index, TString & string, std::vector<Entry>& entries );       	// "projects/library/seqan/sequence_journal/string_journal_utility.h"(492)

//____________________________________________________________________________
// synchronize_index

template <typename TIndex, typename TString, typename TSpec > inline void synchronize_index( TIndex & index, StringSet< TString, TSpec > & stringset );       	// "projects/library/seqan/sequence_journal/string_journal_utility.h"(160)
template <typename TIndex, typename TString > inline void synchronize_index( TIndex & index, TString & string );       	// "projects/library/seqan/sequence_journal/string_journal_utility.h"(337)

//____________________________________________________________________________
// tree_visitor::~tree_visitor

tree_visitor::~tree_visitor();       	// "projects/library/seqan/sequence_journal/string_journal_node.h"(119)

//____________________________________________________________________________
// value

template <typename TValue, typename TSpec, typename TStringSpec, typename TSloppySpec > inline TValue const & value( jiter< TValue, TSpec, TStringSpec, TSloppySpec > const & me );       	// "projects/library/seqan/sequence_journal/iterator_journal.h"(272)
template <typename TValue, typename TSpec, typename TStringSpec, typename TSloppySpec > inline TValue const & value( jiter< TValue, TSpec, TStringSpec, TSloppySpec > & me );       	// "projects/library/seqan/sequence_journal/iterator_journal.h"(277)
