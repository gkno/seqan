				...
				MSA_Protein)
{
	...
	//Score<double, AminoAcidCustom> score_type_global(-1, -11);
	//fillAminoAcidCustom(score_type_global, scType);
...
//
//inline void
//__round(double in, double& out) {
//	out = in;
//}
//
//inline void
//__round(float in, float& out) {
//	out = in;
//}
//
//struct AminoAcidCustom;
//
//
///**
//.Spec.AminoAcidCustom Score
//..cat:Scoring
//..general:Class.Score
//..summary:Scoring scheme that can be modified at runtime.
//*/
//template <typename TValue>
//class Score<TValue, AminoAcidCustom>
//{
//public:
//	TValue data_gap_extend;
//	TValue data_gap_open;
//	String<TValue> data_score;
//
//public:
//	Score(): data_gap_extend(-1), data_gap_open(-2)	{}
//	
//	Score(TValue _gap, TValue _gap_open): data_gap_extend(_gap), data_gap_open(_gap_open) {}
//	
//	Score(Score const & other):	data_gap_extend(other.data_gap_extend),	data_gap_open(other.data_gap_open) {}
//	
//	~Score() {}
//
...
//template <typename TValue>
//inline TValue &
//scoreGapExtend(Score<TValue, AminoAcidCustom> & me)
//{
//	return me.data_gap_extend;
//}
//template <typename TValue>
//inline TValue const &
//scoreGapExtend(Score<TValue, AminoAcidCustom> const & me)
//{
//	return me.data_gap_extend;
//}
//
...
//template <typename TValue>
//inline TValue &
//scoreGapOpen(Score<TValue, AminoAcidCustom> & me)
//{
//	return me.data_gap_open;
//}
//template <typename TValue>
//inline TValue const &
//scoreGapOpen(Score<TValue, AminoAcidCustom> const & me)
//{
//	return me.data_gap_open;
//}
//
...
//template <typename TValue>
//inline TValue
//score(Score<TValue, AminoAcidCustom> const & me,
//	  AminoAcid const& left,
//	  AminoAcid const& right)
//{
//	typename Size<AminoAcid>::Type alphSize = ValueSize<AminoAcid>::VALUE; 
//	return me.data_score[(Byte) left * alphSize + (Byte) right];
//}
//
//template <typename TValue>
//inline TValue
//score(Score<TValue, AminoAcidCustom>& me,
//	  AminoAcid const& left,
//	  AminoAcid const& right)
//{
//	typename Size<AminoAcid>::Type alphSize = ValueSize<AminoAcid>::VALUE; 
...
//
//
//template <typename TValue, typename TData, typename TLambda>
//inline void
//fillAminoAcidCustom(Score<TValue, AminoAcidCustom>& sc,
//					TData backroundFrequencies, 
//					TData targetFrequencies, 
//					TLambda lambda) 
//{
//	typename Size<AminoAcid>::Type alphSize = ValueSize<AminoAcid>::VALUE; 
//	fill(sc.data_score, alphSize*alphSize, 0);
//	// Only 20 amino acids!!!
//	unsigned int count = 0;
//	String<double> matr;
//	fill(matr, alphSize * alphSize, 0);
//	for(unsigned int i = 0; i<20; ++i) {
//		for(unsigned int j = 0; j <= i; ++j) {
//			value(matr, i * alphSize + j) = ((1.0 / lambda) * (log(targetFrequencies[count] / (backroundFrequencies[i] * backroundFrequencies[j]))));
//			value(matr, j * alphSize + i) = value(matr, i * alphSize + j);
//			++count;
//		}
//	}
//	// Fill in the misssing values for B, Z, X, and *
//	unsigned int dIndex = 3;
//	unsigned int nIndex = 2;
//	unsigned int eIndex = 6;
//	unsigned int qIndex = 5;
//	for(unsigned int i = 0; i<20; ++i) {
//		value(matr, 20 * alphSize + i) = (value(matr, 2 * alphSize + i) + value(matr, 3 * alphSize + i)) / 2.0;
//		value(matr, i * alphSize + 20) = value(matr, 20 * alphSize + i);
//		value(matr, 21 * alphSize + i) = (value(matr, 5 * alphSize + i) + value(matr, 6 * alphSize + i)) / 2.0;
//		value(matr, i * alphSize + 21) = value(matr, 21 * alphSize + i);
//	}
//	value(matr, 20 * alphSize + 20) = (value(matr, 2 * alphSize + 2) + value(matr, 3 * alphSize + 3)) / 2.0;
//	value(matr, 21 * alphSize + 21) = (value(matr, 5 * alphSize + 5) + value(matr, 6 * alphSize + 6)) / 2.0;
//	double all = 0;
//	double smallest = 0;
//	for(unsigned int i = 0; i<22; ++i) {
//		double sum = 0;
//		for(unsigned int j = 0; j < 22; ++j) {
//			sum += value(matr, i * alphSize + j);
//			if (value(matr, i * alphSize + j) < smallest) smallest = value(matr, i * alphSize + j);
//		}
//		value(matr, i * alphSize + 22) = sum / 22.0;
//		value(matr, 22 * alphSize + i) = value(matr, i * alphSize + 22);
//		all += value(matr, i * alphSize + 22);
//	}
//	value(matr, 22 * alphSize + 22) = all / 22.0;
//	for(unsigned int i = 0; i<24; ++i) {
//		value(matr, 23 * alphSize + i) = smallest;
//		value(matr, i * alphSize + 23) = smallest;
//	}
//	value(matr, 23 * alphSize + 23) = 0;
//
//	// Round the values to the appropriate data type
//	for(unsigned int i = 0; i<alphSize; ++i) {
//		for(unsigned int j = 0; j < alphSize; ++j) {
//			__round(value(matr, i * alphSize + j), value(sc.data_score, i * alphSize + j));
//		}
//	}
//}
//
...
//fillAminoAcidCustom(Score<TValue, AminoAcidCustom>& sc) 
//{
//	// Default Blosum62 Parameters
//
//	//									A		R		N		D	  C		 Q		E	  G		 H		 I		L	   K	  M		 F		 P		S	  T		 W		Y	   V
//	double backroundFrequencies[20] = {0.074, 0.052, 0.045, 0.054, 0.025, 0.034, 0.054, 0.074, 0.026, 0.068, 0.099, 0.058, 0.025, 0.047, 0.039, 0.057, 0.051, 0.013, 0.034, 0.073};
// 
//	double targetFrequencies[210] = {
//				0.0219414,
//				0.00271979,0.0153288,
//				0.00166358,0.00234,0.0162415,
//				0.0019963,0.0014028,0.003438,0.0233878,
//				0.00185,0.000459032,0.000397239,0.000476687,0.0141965,
//				0.00177832,0.0025014,0.00153,0.001836,0.000300136,0.00655328,
//				0.00282439,0.002808,0.00243,0.00583698,0.000336925,0.00367513,0.0165306,
//				0.005476,0.00192236,0.00333,0.00282439,0.000653238,0.00125693,0.0019963,0.0439202,
//				0.00096118,0.001352,0.00165534,0.000992355,0.000229516,0.000884,0.001404,0.00096118,0.010853,
//				0.00355664,0.00124857,0.00108049,0.00129659,0.00120157,0.00081637,0.00129659,0.00125586,0.000624283,0.0185276,
//				0.00517806,0.00257181,0.00157307,0.00133422,0.00174934,0.00168157,0.00188768,0.00182838,0.000908883,0.0134755,0.0392709,
//				0.00303361,0.00603715,0.00261,0.00221371,0.000511997,0.00279002,0.00443121,0.00214417,0.00106586,0.00139263,0.00286855,0.0190703,
//				0.00130759,0.000918847,0.00056202,0.000476687,0.000441753,0.00085,0.000674425,0.000653238,0.000324723,0.00240519,0.00495422,0.00102487,0.00354308,
//				0.00173752,0.00086298,0.000746809,0.000896171,0.000586999,0.000564256,0.000896171,0.00122809,0.000863716,0.003196,0.004653,0.000962554,0.001175,0.0177173,
//				0.00203984,0.00101314,0.000876752,0.00148853,0.000344274,0.000937224,0.00148853,0.00144177,0.000506568,0.000936425,0.00136332,0.00159879,0.000487084,0.000457469,0.0172596,
//				0.0059677,0.00209497,0.003629,0.003078,0.0010072,0.001938,0.003078,0.004218,0.00104749,0.00193635,0.00281909,0.003306,0.0010072,0.00133836,0.00157123,0.0130182,
//				0.003774,0.00187445,0.002295,0.00194654,0.000901177,0.0012256,0.00194654,0.00188539,0.000662435,0.0024512,0.00356866,0.00209073,0.000901177,0.00119748,0.00140584,0.00411287,0.0147449,
//				0.000339684,0.000238697,0.000146001,0.000175201,0.000162361,0.000220812,0.000247877,0.00048059,0.000168856,0.000312142,0.000642951,0.000266238,0.000229712,0.000864453,0.000126534,0.000261648,0.000331217,0.00768402,
//				0.00125693,0.000883246,0.000764348,0.000648294,0.000424638,0.000817067,0.000917217,0.000888403,0.00176951,0.00163413,0.00237911,0.000985159,0.000600785,0.00452561,0.000468212,0.000968174,0.000866261,0.000884754,0.0131177,
//				0.005402,0.00134037,0.00115994,0.00139193,0.00128992,0.00123994,0.00196932,0.00190745,0.000670186,0.0140583,0.0102249,0.0021152,0.00258204,0.00242505,0.00142229,0.00207873,0.003723,0.000335093,0.00175429,0.0213524
//	};
//	double lambda = 0.347;
//	
//	fillAminoAcidCustom(sc, backroundFrequencies, targetFrequencies, lambda);
//}
//
//template <typename TValue, typename TScoreType>
//inline void
//fillAminoAcidCustom(Score<TValue, AminoAcidCustom>& sc,
//					TScoreType const& scType) 
//{
//	typename Size<AminoAcid>::Type alphSize = ValueSize<AminoAcid>::VALUE; 
//	reserve(sc.data_score, alphSize*alphSize);
//	for(unsigned int i = 0; i<alphSize; ++i) {
//		for(unsigned int j = 0; j<alphSize; ++j) {
//			value(sc.data_score, i * alphSize + j) = score(const_cast<TScoreType&>(scType), AminoAcid(i), AminoAcid(j));
//		}
//	}
//}
//
//template <typename TValue, typename TStringSet, typename TCargo, typename TSpec>
//inline void
//fillAminoAcidCustom(Score<TValue, AminoAcidCustom>& sc,
...
//	typedef typename Iterator<TSequence>::Type TSeqIter;
//	typedef typename Iterator<TGraph, EdgeIterator>::Type TEdgeIterator;
//
//	// Count all occurrences
//	String<double> backFreq;
//	fill(backFreq, 20, 0);
//	String<double> targetFreq;
//	fill(targetFreq, 20 * 20, 0);
//	TSize pairCount = 0;
//	TEdgeIterator it_tmp(g);
//	for(;!atEnd(it_tmp);++it_tmp) {
//		TSequence seqA = label(g,sourceVertex(it_tmp));
//		TSequence seqB = label(g,targetVertex(it_tmp));
//		std::cout << seqA << ',' << seqB << std::endl;
//		TSeqIter seqAIt = begin(seqA);
//		TSeqIter seqBIt = begin(seqB);
//		TSeqIter seqAItEnd = end(seqA);
//		for(;seqAIt != seqAItEnd; ++seqAIt, ++seqBIt) {
//			unsigned int i = (unsigned int) *seqAIt;
//			unsigned int j = (unsigned int) *seqBIt;
//			if ((i>=20) || (j>=20)) continue;
//			value(backFreq, i) += 1;
//			value(backFreq, j) += 1;
//			if (i < j) value(targetFreq, j * 20 + i) += 1;
//			else value(targetFreq, i * 20 + j) += 1;
//			++pairCount;
//		}
//	}
//
...
//			value(backFreq, i) += 1;
//			value(backFreq, j) += 1;
//			value(targetFreq, i * 20 + j) += 1;
//			++pairCount;
//		}
//	}
//
//	// Normalize
//	String<double> finalTargetFreq;
//	for(unsigned int i=0; i<20; ++i) {
//		for(unsigned int j=0; j<=i; ++j) {
//			value(targetFreq, i * 20 + j) /= (double) pairCount;
//			appendValue(finalTargetFreq, value(targetFreq, i * 20 + j));
//		}
//	}
//	for(unsigned int i=0; i<20; ++i) value(backFreq, i) /= (2.0 * (double) pairCount);
//
//
//	// Mix in the background distribution and normalize
//	//									A		R		N		D	  C		 Q		E	  G		 H		 I		L	   K	  M		 F		 P		S	  T		 W		Y	   V
//	double backroundFrequencies[20] = {0.074, 0.052, 0.045, 0.054, 0.025, 0.034, 0.054, 0.074, 0.026, 0.068, 0.099, 0.058, 0.025, 0.047, 0.039, 0.057, 0.051, 0.013, 0.034, 0.073};
// 	double targetFrequencies[210] = {
//				0.0219414,
...
//	};
//
//	double myContrib = 0.3;
//	double sum = 0;
//	unsigned int count = 0;
//	for(unsigned int i=0; i<20; ++i) {
//		for(unsigned int j=0; j<=i; ++j) {
//			value(finalTargetFreq, count) = myContrib * value(finalTargetFreq, count) + (1.0 - myContrib) * targetFrequencies[count];
//			sum += value(finalTargetFreq, count);
//			++count;
//		}
//	}
//	count = 0;
//	for(unsigned int i=0; i<20; ++i) {
//		for(unsigned int j=0; j<=i; ++j) {
//			value(finalTargetFreq, count) /= sum;
//			++count;
//		}
//	}
//	sum = 0;
//	for(unsigned int i=0; i<20; ++i) {
//		value(backFreq, i) = myContrib * value(backFreq, i) + (1.0 - myContrib) * backroundFrequencies[i];
//		sum += value(backFreq, i);
//	}
//	for(unsigned int i=0; i<20; ++i) {
//		value(backFreq, i) /= sum;
//	}
//	
//	double lambda = 0.347;
//
//	fillAminoAcidCustom(sc, backFreq, finalTargetFreq, lambda);
//	//fillAminoAcidCustom(sc, backroundFrequencies, targetFrequencies, lambda);
//}
//
//template <typename TValue>
//inline void
//offsetAminoAcidCustom(Score<TValue, AminoAcidCustom>& sc,
//					  TValue offset)
//{
//	typename Size<AminoAcid>::Type alphSize = ValueSize<AminoAcid>::VALUE; 
//	
//	for(unsigned int i = 0; i<alphSize; ++i) {
//		for(unsigned int j = 0; j<alphSize; ++j) {
//			value(sc.data_score, i * alphSize + j) += offset;
//		}
//	}
//}
//
...
//	for(unsigned int i = 0; i<alphSize; ++i) {
//		for(unsigned int j = 0; j<alphSize; ++j) {
//			if (value(sc.data_score, i * alphSize + j) < smallest) smallest = value(sc.data_score, i * alphSize + j);
//		}
//	}
//	offsetAminoAcidCustom(sc, (-1) * smallest + 1);
//}
//
//
//template <typename TValue, typename TBackgroundfreq>
//inline void
//adaptAminoAcidCustom(Score<TValue, AminoAcidCustom>& sc,
//					 TBackgroundfreq& backroundFrequencies)
//{
//	typename Size<AminoAcid>::Type alphSize = ValueSize<AminoAcid>::VALUE; 
//	double defaultBackroundFrequencies[20] = {0.074, 0.052, 0.045, 0.054, 0.025, 0.034, 0.054, 0.074, 0.026, 0.068, 0.099, 0.058, 0.025, 0.047, 0.039, 0.057, 0.051, 0.013, 0.034, 0.073};
//
//	for(unsigned int i = 0; i<alphSize; ++i) {
//		for(unsigned int j = 0; j<alphSize; ++j) {
//			value(sc.data_score, i * alphSize + j) *= ((defaultBackroundFrequencies[i] * defaultBackroundFrequencies[j]) / (backroundFrequencies[i] * backroundFrequencies[j]));
//		}
//	}
//}
//
...
//{
//	// Swissprot
//	double backroundFrequencies[20] = {0.0809, 0.0549, 0.0405, 0.0540, 0.0143, 0.0395, 0.0672, 0.0702, 0.0229, 0.0590, 0.0967, 0.0589, 0.0241, 0.0389, 0.0479, 0.0669, 0.0536, 0.0110, 0.0295, 0.0681};
//
//	adaptAminoAcidCustom(sc, backroundFrequencies);
//}
