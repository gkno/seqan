...
//____________________________________________________________________________
	...
	template< typename TObject, typename TModus, typename TSpec, typename TStructuring > inline 
	Allocator< ChunkPool< sizeof(SkipElement<TObject, TModus, TSpec, TStructuring>) > > & 
	...
	template< typename TObject, typename TModus, typename TSpec, typename TStructuring > inline 
	Allocator< SinglePool<sizeof(SkipBaseElement<TObject, TModus, TSpec, TStructuring>) > > & 
...
{	
	...
	typename Size< SkipList< TObject, TModus, TSpec, TStructuring > >::Type _numOfElements;
		...
		// pool allocators
	Allocator< ChunkPool< sizeof(TSkipElement) > > _elementAlloc;
	Allocator< SinglePool< sizeof(TSkipBaseElement) > > _baseAlloc;
