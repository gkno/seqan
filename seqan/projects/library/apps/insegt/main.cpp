...
#include "base.h"
#include <store_align_intervals.h>
#include "read_gff.h"
#include <store_intervaltree.h>
...
int main( int argc, const char *argv[] ) 
{
	...
	ngsOverlapper(nameSAM, nameFASTA, nameGFF, outputPath, nTuple, exact_nTuple, thresholdGaps, offsetInterval, thresholdCount, thresholdRPKM);
