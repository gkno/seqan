/*
 * af_d2star_original.h
 *
 *  Created on: 7 Dec 2009
 *      Author: goeke
 */

#ifndef AF_D2STAR_ORIGINAL_H_
#define AF_D2STAR_ORIGINAL_H_
...
void _alignmentFreeComparison(Matrix<TValue, 2> & scoreMatrix,TStringSet const &sequenceSet, AF_Score<D2star_original> const &score)
{
...
void
alignmentFreeCompareCounts(TValue &result, TString &kmerCounts1, TString &kmerCounts2, AF_Score<D2star_original> const &score)
{
...
void d2star_original(TValue &result, TSequence const &sequence1, TSequence const &sequence2, AF_Score<D2star_original> const &score)
{
...
void standardisedCounts(TString &standardisedCounts, TSequence const &sequence, AF_Score<D2star_original> const &score)
{
